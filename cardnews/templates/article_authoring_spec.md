...
> **★ 영상 길이 목표 = 35~45초** (SNS 리텐션). 길이는 narration/카드 본문 글자수가 좌우한다
> (TTS +42% 기준 56초는 길다). 규칙: **카드 본문 한 문장 ≤ 약 35자, 6카드 본문 합계 ≈ 250자 이내**,
> 팩트 카드는 4개 유지하되 문장을 짧고 굵게. 군더더기(예: "~것으로 전망됩니다" 반복) 줄이기.
> narration_md 도 같은 분량으로 맞춘다. 길이가 핵심 사실을 못 담을 정도면 팩트 3개로 줄여도 됨.
