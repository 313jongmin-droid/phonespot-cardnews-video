...
> **★ 영상 길이 목표 = 25~30초** (2026-06-18 결정. 짧을수록 평균 시청%↑ = 쇼츠 추천 핵심 신호, 정보밀도는 유지).
> 길이는 narration/카드 본문 글자수가 좌우한다. 규칙: **카드 본문 한 문장 ≤ 약 30자, 6카드 본문 합계 ≈ 180자 이내**
> (기존 250자에서 축소), **팩트 카드 기본 3개**(4개는 예외). 군더더기("~것으로 전망됩니다" 반복) 제거.
> **★ 1영상 = 1주장**: 스펙+가격+CTA를 한 영상에 다 넣지 말 것(유지율 분산). 카드마다 한 메시지,
> 영상 전체는 날카로운 주장 하나로 수렴. narration_md 도 같은 분량. 사실 못 담을 정도면 팩트 더 줄여도 됨(주장 1개 우선).
